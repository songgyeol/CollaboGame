...
struct CustomColor {
    static let backgroundColor = UIColor(red: 0.11, green: 0.05, blue: 0.36, alpha: 1.00)
    static let mainColor = UIColor(red:0.51, green:0.67, blue:1.00, alpha:1.0)
    static let startBtnColor = UIColor(red: 0.62, green: 0.71, blue: 1.00, alpha: 1.00)
    static let passBtnColor = UIColor(red: 0.60, green: 1.00, blue: 0.80, alpha: 1.00)
    static let mainTextColor = UIColor(red:0.00, green:0.14, blue:0.40, alpha:1.0)//UIColor(red: 0.95, green: 0.95, blue: 0.95, alpha: 1.00)
